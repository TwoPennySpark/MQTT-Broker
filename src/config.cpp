...
void config_print(void)
{
    if (config.loglevel < WARNING) {
        const char *sfamily = config.socket_family == AF_UNIX ? "Unix" : "Tcp";
        ...
        if (config.socket_family == AF_UNIX) {
